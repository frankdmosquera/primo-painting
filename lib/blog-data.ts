...
export const blogPosts: BlogPost[] = [
  {
    ...
    description: `<p>Before you go for a DIY job or the assistance of a professional cabinet painting company in Calgary, there are a few things that you should keep in mind.</p></br><p>Choosing the right paint for your cabinets is essential to achieve the look you want. Not all paints suit all surfaces, especially when it comes to painting cabinets. Water-based paints are popular for their low odour and easy cleanup, while oil-based or alkyd paints offer a tougher, more durable finish. Many homeowners prefer a semi-gloss or satin finish, as it provides a good balance between easy cleaning and a smooth look.</p></br><p>The second important tip for a great paint job is ensuring that the surface is properly prepared. To ensure a smooth finish, the surface of the cabinets should be cleaned in detail to remove any built-up grime. If you are doing it yourself, follow the steps carefully. If you're not so sure, it's best to reach out to a <a href='https://www.primopainting.ca/cabinet-painting-calgary' class="text-blue">professional cabinet painter in Calgary</a>. Experts are equipped with the right tools and techniques that suit your preferences and budget.</p></br><p>If you are following a DIY approach, it is best advised to label all the cabinet doors and drawers before removing them so you know exactly where each one goes later. This will save you time and effort and ensure everything goes on smoothly.</p></br><p>When it’s time to paint, going slow and applying thin, even coats is the right way to go about it. Applying too much at once can cause drips, uneven texture, or bubbling. A professional knows all the right techniques to get your cabinet that even and clean look, which you might not be able to achieve following a DIY  approach. Depending on the type and colour of the paint, two or three coats might be required for full coverage.</p></br><p>Follow the tips mentioned above and achieve a sleek look for your cabinets. If you are looking for a professional cabinet <a href='https://www.primopainting.ca/' class="text-blue"> painting company in Calgary</a>, Primo Painters is where you can get all your needs met with precision and excellent customer satisfaction.</p>`,
    cronical: `<link rel="canonical" href="https://www.primopainting.ca/blog/cabinet-painting-tips-every-homeowner-should-know"/>`,
  ...
  },
  {
    ...
    <p>The clearest sign that your house needs exterior <a href='https://www.primopainting.ca/' class="text-blue">painting services</a> is if you observe peeling, bubbling, or cracking of the paint. This means that the damage has already set in, and it's time to get it redone before the problem worsens.</p></br> 
