...
const HomeHero = () => {
  return (
    <section className="relative h-[38rem] tn:h-[40rem] xsm:h-[42rem] md:h-[44rem] lg:h-[46rem] xl:h-[calc(100vh-9.1rem)]">
      <Image
        src={HeroHomeImg.src}
        alt={HeroHomeImg.alt}
        fill
      ...
      <div className=" absolute  px-4 gap-8 inset-0 flex  flex-col items-center justify-center text-center ">
        <div className="">
